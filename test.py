...
filename = "student_depression_dataset1(in).csv"
...
# from lambdas.upload.lambda_function import lambda_handler
# from lambdas.upload.util import validate_and_clean_data
# import pandas as pd

# # Load CSV file into a DataFrame
# df = pd.read_csv(filename)
# # res = lambda_handler(file_b64, filename, "admin")
# new_df = validate_and_clean_data(df)
# print(new_df)
